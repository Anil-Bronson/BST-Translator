...
private:
    ...
    bool insertR(const ElementType& element, BSTNode<ElementType>* current); 
		//check out the slides posted in class and noates
	...
	void clear();
	void clearNode(BSTNode<ElementType>* current) const;

	void CopyH(BSTNode<ElementType>* copyFrom, BSTNode<ElementType>* copyTo);
